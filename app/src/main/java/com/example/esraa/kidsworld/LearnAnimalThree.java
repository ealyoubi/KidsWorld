...
public class LearnAnimalThree extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_learn_animal_three);
        final MediaPlayer PandaSound =MediaPlayer.create(this,R.raw.panda);
        Button button=(Button)findViewById(R.id.panda);
